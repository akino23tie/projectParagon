...
export default function Header() {
  const navItemClass = ({ isActive }) => `block w-full text-left text-sm px-4 py-2 rounded-lg transition font-medium ${isActive ? "bg-black text-white" : "text-gray-700 hover:bg-gray-200"}`;
